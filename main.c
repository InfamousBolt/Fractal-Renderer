...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/11 15:59:11 by keshav            #+#    #+#             */
/*   Updated: 2021/12/11 17:10:44 by keshav           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_error(t_data *data, char **argv)
{
	...
	{
		free(data);
		printf("\nHey Buddy! Did you enter an invalid argument? ");
		printf("Or missed some arguments :\n %s", argv[0]);
		printf(" (chosing one of the fractal sets is mandatory)\n\n");
		printf("	-julia	: shows the Julia set\n");
		printf("	-mandel	: the shows Mandelbrot set\n");
